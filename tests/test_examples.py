...
import re
from yaml_workflow_engine.cli import main
import sys
...
def example_workflows_dir():
    ...
    return Path(__file__).parent.parent / "src" / "yaml_workflow_engine" / "examples"
...
def test_basic_hello_world(run_cli, example_workflows_dir, workspace_dir):
    ...
    exit_code, out, err = run_cli([
        ...
        '--base-dir', str(workspace_dir.parent)
    ])
