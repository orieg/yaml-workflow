...
def test_step_init_basic(basic_step_data, basic_context, mock_dirs, template_engine):
    ...
    step = Step(basic_step_data, basic_context, workspace_dir, output_dir, template_engine)
...
def test_step_init_on_error_dict(basic_step_data, basic_context, mock_dirs, template_engine):
...
def test_step_init_on_error_string(basic_step_data, basic_context, mock_dirs, template_engine):
...
def test_step_init_on_error_invalid(basic_step_data, basic_context, mock_dirs, template_engine, caplog):
...
def test_evaluate_condition_no_condition(basic_step_data, basic_context, mock_dirs, template_engine):
    """Test evaluate_condition returns True when no condition is set."""
    workspace_dir, output_dir = mock_dirs
    step = Step(basic_step_data, basic_context, workspace_dir, output_dir, template_engine)
    assert step.evaluate_condition() is True

def test_evaluate_condition_true(basic_step_data, basic_context, mock_dirs, template_engine):
...
def test_evaluate_condition_false(basic_step_data, basic_context, mock_dirs, template_engine):
...
def test_evaluate_condition_template_error(basic_step_data, basic_context, mock_dirs, template_engine, caplog):
...
def test_evaluate_condition_other_exception(basic_step_data, basic_context, mock_dirs, template_engine, caplog):
...
def test_render_inputs_simple(basic_step_data, basic_context, mock_dirs, template_engine):
...
def test_render_inputs_nested(basic_step_data, basic_context, mock_dirs, template_engine):
...
def test_render_inputs_template_error(basic_step_data, basic_context, mock_dirs, template_engine, caplog):
...
def test_render_inputs_other_exception(basic_step_data, basic_context, mock_dirs, template_engine, caplog):
...
def test_handle_error_fail_default(basic_step_data, basic_context, mock_dirs, template_engine, caplog):
...
def test_handle_error_continue(basic_step_data, basic_context, mock_dirs, template_engine, caplog):
    ...
    assert "Error in step 'test_step': Something broke" in result["message"]
    assert f"Step '{step.name}' failed but workflow continues: {result['message']}" in caplog.text

def test_handle_error_custom_message(basic_step_data, basic_context, mock_dirs, template_engine, caplog):
...
def test_handle_error_custom_message_render_fail(basic_step_data, basic_context, mock_dirs, template_engine, caplog):
