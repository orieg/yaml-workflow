...
def custom_task_module():
    ...
    def custom_task(step: Dict[str, Any], context: Dict[str, Any], workspace: str) -> Dict[str, Any]:
...
def test_custom_task_registration():
    ...
    from yaml_workflow_engine.tasks import get_task_handler
